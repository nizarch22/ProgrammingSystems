...
80100cd3:	e8 e8 3b 00 00       	call   801048c0 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 d4 3b 00 00       	call   801048c0 <strlen>
...
80100da1:	e8 da 3a 00 00       	call   80104880 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e20:	e8 0b 36 00 00       	call   80104430 <initlock>
}
...
80100e71:	e8 2a 37 00 00       	call   801045a0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 11 37 00 00       	call   801045a0 <release>
}
...
80100eaf:	e8 4c 37 00 00       	call   80104600 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 cf 36 00 00       	call   801045a0 <release>
  return f;
}
...
80100f01:	e8 fa 36 00 00       	call   80104600 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 5f 36 00 00       	call   801045a0 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 2d 36 00 00       	jmp    801045a0 <release>
...
80101325:	e8 96 33 00 00       	call   801046c0 <memset>
  log_write(bp);
...
801013d7:	e8 c4 31 00 00       	call   801045a0 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 96 31 00 00       	call   801045a0 <release>
      return ip;
...
80101541:	e8 1a 32 00 00       	call   80104760 <memmove>
  brelse(bp);
...
80101576:	e8 b5 2e 00 00       	call   80104430 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 6c 2d 00 00       	call   80104300 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 9f 31 00 00       	call   80104760 <memmove>
  brelse(bp);
...
8010168e:	e8 2d 30 00 00       	call   801046c0 <memset>
      dip->type = type;
...
80101731:	e8 2a 30 00 00       	call   80104760 <memmove>
  log_write(bp);
...
8010175f:	e8 9c 2e 00 00       	call   80104600 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 2c 2e 00 00       	call   801045a0 <release>
}
...
801017a2:	e8 99 2b 00 00       	call   80104340 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 43 2f 00 00       	call   80104760 <memmove>
    brelse(bp);
...
80101873:	e8 68 2b 00 00       	call   801043e0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 0c 2b 00 00       	jmp    801043a0 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 7b 2a 00 00       	call   80104340 <acquiresleep>
...
801018da:	e8 c1 2a 00 00       	call   801043a0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 15 2d 00 00       	call   80104600 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 9b 2c 00 00       	jmp    801045a0 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 eb 2c 00 00       	call   80104600 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 7c 2c 00 00       	call   801045a0 <release>
    if(r == 1){
...
80101a23:	e8 b8 29 00 00       	call   801043e0 <holdingsleep>
...
80101a3a:	e8 61 29 00 00       	call   801043a0 <releasesleep>
  iput(ip);
...
80101b37:	e8 24 2c 00 00       	call   80104760 <memmove>
    brelse(bp);
...
80101c33:	e8 28 2b 00 00       	call   80104760 <memmove>
    log_write(bp);
...
80101cce:	e8 fd 2a 00 00       	call   801047d0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 9e 2a 00 00       	call   801047d0 <strncmp>
      continue;
...
80101dba:	e8 41 28 00 00       	call   80104600 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 d1 27 00 00       	call   801045a0 <release>
...
80101e27:	e8 34 29 00 00       	call   80104760 <memmove>
...
80101e8c:	e8 4f 25 00 00       	call   801043e0 <holdingsleep>
...
80101eae:	e8 ed 24 00 00       	call   801043a0 <releasesleep>
  iput(ip);
...
80101edb:	e8 80 28 00 00       	call   80104760 <memmove>
    name[len] = 0;
...
80101f2b:	e8 b0 24 00 00       	call   801043e0 <holdingsleep>
...
80101f4a:	e8 51 24 00 00       	call   801043a0 <releasesleep>
  iput(ip);
...
80101f6d:	e8 6e 24 00 00       	call   801043e0 <holdingsleep>
...
80101f90:	e8 4b 24 00 00       	call   801043e0 <holdingsleep>
...
80101fa7:	e8 f4 23 00 00       	call   801043a0 <releasesleep>
}
...
8010203d:	e8 de 27 00 00       	call   80104820 <strncpy>
...
801021d0:	e8 5b 22 00 00       	call   80104430 <initlock>
...
8010224e:	e8 ad 23 00 00       	call   80104600 <acquire>
...
801022ad:	e8 ae 1e 00 00       	call   80104160 <wakeup>
...
801022cb:	e8 d0 22 00 00       	call   801045a0 <release>
...
801022ee:	e8 ed 20 00 00       	call   801043e0 <holdingsleep>
...
80102328:	e8 d3 22 00 00       	call   80104600 <acquire>
...
80102369:	e8 32 1d 00 00       	call   801040a0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 15 22 00 00       	jmp    801045a0 <release>
...
801024f2:	e8 c9 21 00 00       	call   801046c0 <memset>
...
80102528:	e8 d3 20 00 00       	call   80104600 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 58 20 00 00       	jmp    801045a0 <release>
    panic("kfree");
...
80102625:	e8 06 1e 00 00       	call   80104430 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 48 1f 00 00       	call   80104600 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 ba 1e 00 00       	call   801045a0 <release>
  return (char*)r;
...
80102af7:	e8 14 1c 00 00       	call   80104710 <memcmp>
...
80102c24:	e8 37 1b 00 00       	call   80104760 <memmove>
...
80102cd4:	e8 57 17 00 00       	call   80104430 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 90 18 00 00       	call   80104600 <acquire>
...
80102d85:	e8 16 13 00 00       	call   801040a0 <sleep>
...
80102dbc:	e8 df 17 00 00       	call   801045a0 <release>
      break;
    }
  }
}
...
80102dde:	e8 1d 18 00 00       	call   80104600 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 7f 17 00 00       	call   801045a0 <release>
}
...
80102e36:	e8 c5 17 00 00       	call   80104600 <acquire>
    wakeup(&log);
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 0f 13 00 00       	call   80104160 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
80102e58:	e8 43 17 00 00       	call   801045a0 <release>
...
80102eb4:	e8 a7 18 00 00       	call   80104760 <memmove>
...
80102f08:	e8 53 12 00 00       	call   80104160 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
80102f14:	e8 87 16 00 00       	call   801045a0 <release>
...
80102f76:	e8 85 16 00 00       	call   80104600 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 e6 15 00 00       	jmp    801045a0 <release>
...
801033c8:	e8 43 13 00 00       	call   80104710 <memcmp>
...
801034a9:	e8 82 0f 00 00       	call   80104430 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 bc 10 00 00       	call   80104600 <acquire>
  if(writable){
...
8010355f:	e8 fc 0b 00 00       	call   80104160 <wakeup>
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 17 10 00 00       	jmp    801045a0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 07 10 00 00       	call   801045a0 <release>
    kfree((char*)p);
...
801035c4:	e8 97 0b 00 00       	call   80104160 <wakeup>
...
801035dd:	e8 1e 10 00 00       	call   80104600 <acquire>
  for(i = 0; i < n; i++){
...
80103638:	e8 23 0b 00 00       	call   80104160 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010363d:	58                   	pop    %eax
8010363e:	5a                   	pop    %edx
8010363f:	53                   	push   %ebx
80103640:	56                   	push   %esi
80103641:	e8 5a 0a 00 00       	call   801040a0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010366c:	e8 2f 0f 00 00       	call   801045a0 <release>
        return -1;
...
801036ba:	e8 a1 0a 00 00       	call   80104160 <wakeup>
  release(&p->lock);
801036bf:	89 1c 24             	mov    %ebx,(%esp)
801036c2:	e8 d9 0e 00 00       	call   801045a0 <release>
  return n;
...
801036e6:	e8 15 0f 00 00       	call   80104600 <acquire>
...
80103715:	e8 86 09 00 00       	call   801040a0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103776:	e8 e5 09 00 00       	call   80104160 <wakeup>
  release(&p->lock);
8010377b:	89 34 24             	mov    %esi,(%esp)
8010377e:	e8 1d 0e 00 00       	call   801045a0 <release>
  return i;
...
801037c1:	e8 3a 0e 00 00       	call   80104600 <acquire>
...
80103814:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
8010381a:	e8 81 0d 00 00       	call   801045a0 <release>
...
8010383c:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010383f:	c7 40 14 ff 58 10 80 	movl   $0x801058ff,0x14(%eax)
  p->context = (struct context*)sp;
...
8010384e:	e8 6d 0e 00 00       	call   801046c0 <memset>
...
8010387a:	e8 21 0d 00 00       	call   801045a0 <release>
}
...
801038ab:	e8 f0 0c 00 00       	call   801045a0 <release>
...
801038f6:	68 80 77 10 80       	push   $0x80107780
801038fb:	68 20 1d 11 80       	push   $0x80111d20
80103900:	e8 2b 0b 00 00       	call   80104430 <initlock>
}
...
80103994:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103997:	e8 14 0b 00 00       	call   801044b0 <pushcli>
  c = mycpu();
8010399c:	e8 6f ff ff ff       	call   80103910 <mycpu>
  p = c->proc;
801039a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039a7:	e8 54 0b 00 00       	call   80104500 <popcli>
}
...
801039d3:	e8 18 35 00 00       	call   80106ef0 <setupkvm>
...
801039f1:	e8 aa 31 00 00       	call   80106ba0 <inituvm>
...
80103a06:	e8 b5 0c 00 00       	call   801046c0 <memset>
...
80103a5f:	68 b0 77 10 80       	push   $0x801077b0
80103a64:	50                   	push   %eax
80103a65:	e8 16 0e 00 00       	call   80104880 <safestrcpy>
  p->cwd = namei("/");
80103a6a:	c7 04 24 b9 77 10 80 	movl   $0x801077b9,(%esp)
...
80103a93:	e8 08 0b 00 00       	call   801045a0 <release>
}
...
80103aa3:	68 97 77 10 80       	push   $0x80107797
...
80103ab5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103ab8:	e8 f3 09 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103abd:	e8 4e fe ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103ac2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ac8:	e8 33 0a 00 00       	call   80104500 <popcli>
  sz = curproc->sz;
...
80103adb:	e8 b0 2f 00 00       	call   80106a90 <switchuvm>
  return 0;
...
80103b36:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b39:	e8 72 09 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103b3e:	e8 cd fd ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103b43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b49:	e8 b2 09 00 00       	call   80104500 <popcli>
  if((np = allocproc()) == 0){
...
80103b68:	e8 73 34 00 00       	call   80106fe0 <copyuvm>
...
80103c7e:	e8 7d 09 00 00       	call   80104600 <acquire>
...
80103ca0:	e8 eb 2d 00 00       	call   80106a90 <switchuvm>
...
80103cab:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103cb2:	e8 24 0c 00 00       	call   801048db <swtch>
      switchkvm();
...
80103cdf:	e8 bc 08 00 00       	call   801045a0 <release>
    sti();
...
80103d53:	e8 83 0b 00 00       	call   801048db <swtch>
  mycpu()->intena = intena;
...
80103e1a:	e8 e1 07 00 00       	call   80104600 <acquire>
...
80103ec7:	68 08 78 10 80       	push   $0x80107808
80103ecc:	e8 af c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ed1:	83 ec 0c             	sub    $0xc,%esp
80103ed4:	68 fb 77 10 80       	push   $0x801077fb
...
80103f02:	e8 f9 06 00 00       	call   80104600 <acquire>
...
80103f51:	0f 85 8f 00 00 00    	jne    80103fe6 <wait+0x106>
  pushcli();
80103f57:	e8 54 05 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103f5c:	e8 af f9 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103f61:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f67:	e8 94 05 00 00       	call   80104500 <popcli>
  if(p == 0)
...
80103fa9:	e8 c2 2e 00 00       	call   80106e70 <freevm>
        p->pid = 0;
...
80103fd5:	e8 c6 05 00 00       	call   801045a0 <release>
        return pid;
...
80104014:	53                   	push   %ebx
  pushcli();
80104015:	e8 96 04 00 00       	call   801044b0 <pushcli>
  c = mycpu();
8010401a:	e8 f1 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
8010401f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104025:	e8 d6 04 00 00       	call   80104500 <popcli>
  int yieldRequired = (1<<(p->P));
8010402a:	b8 01 00 00 00       	mov    $0x1,%eax
8010402f:	8b 4b 7c             	mov    0x7c(%ebx),%ecx
80104032:	d3 e0                	shl    %cl,%eax
80104034:	89 c2                	mov    %eax,%edx
  p->yieldTicks++;
80104036:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
8010403c:	83 c0 01             	add    $0x1,%eax
8010403f:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  if(p->yieldTicks<yieldRequired)
80104045:	39 d0                	cmp    %edx,%eax
80104047:	7c 47                	jl     80104090 <yield+0x80>
  acquire(&ptable.lock);  //DOC: yieldlock
80104049:	83 ec 0c             	sub    $0xc,%esp
8010404c:	68 20 1d 11 80       	push   $0x80111d20
80104051:	e8 aa 05 00 00       	call   80104600 <acquire>
  pushcli();
80104056:	e8 55 04 00 00       	call   801044b0 <pushcli>
  c = mycpu();
8010405b:	e8 b0 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80104060:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104066:	e8 95 04 00 00       	call   80104500 <popcli>
  myproc()->state = RUNNABLE;
8010406b:	c7 46 0c 03 00 00 00 	movl   $0x3,0xc(%esi)
  sched();
80104072:	e8 79 fc ff ff       	call   80103cf0 <sched>
  release(&ptable.lock);
80104077:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010407e:	e8 1d 05 00 00       	call   801045a0 <release>
  p->yieldTicks =0;
80104083:	83 c4 10             	add    $0x10,%esp
80104086:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
8010408d:	00 00 00 
}
...
801040af:	e8 fc 03 00 00       	call   801044b0 <pushcli>
  c = mycpu();
801040b4:	e8 57 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
...
801040f0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801040f7:	e8 f4 fb ff ff       	call   80103cf0 <sched>
  p->chan = 0;
...
8010412b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104132:	e8 b9 fb ff ff       	call   80103cf0 <sched>
  p->chan = 0;
...
80104149:	68 1a 78 10 80       	push   $0x8010781a
8010414e:	e8 2d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104153:	83 ec 0c             	sub    $0xc,%esp
80104156:	68 14 78 10 80       	push   $0x80107814
...
8010427f:	74 e7                	je     80104268 <procdump+0x28>
      state = "???";
80104281:	ba 2b 78 10 80       	mov    $0x8010782b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104286:	83 f8 05             	cmp    $0x5,%eax
80104289:	77 11                	ja     8010429c <procdump+0x5c>
8010428b:	8b 14 85 8c 78 10 80 	mov    -0x7fef8774(,%eax,4),%edx
      state = "???";
80104292:	b8 2b 78 10 80       	mov    $0x8010782b,%eax
...
801042a1:	68 2f 78 10 80       	push   $0x8010782f
...
801042dd:	68 81 72 10 80       	push   $0x80107281
...
8010430a:	68 a4 78 10 80       	push   $0x801078a4
...
80104373:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104379:	e8 12 f6 ff ff       	call   80103990 <myproc>
...
8010441b:	e8 70 f5 ff ff       	call   80103990 <myproc>
...
801044da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801044e0:	e8 2b f4 ff ff       	call   80103910 <mycpu>
...
80104545:	68 af 78 10 80       	push   $0x801078af
8010454a:	e8 31 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010454f:	83 ec 0c             	sub    $0xc,%esp
80104552:	68 c6 78 10 80       	push   $0x801078c6
...
80104583:	e8 88 f3 ff ff       	call   80103910 <mycpu>
...
8010463c:	e8 cf f2 ff ff       	call   80103910 <mycpu>
...
801046b0:	68 d5 78 10 80       	push   $0x801078d5
...
80104adc:	8b 14 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%edx
...
80104b08:	68 dd 78 10 80       	push   $0x801078dd
...
80104c64:	68 7c 79 10 80       	push   $0x8010797c
...
80104c7c:	68 7b 79 10 80       	push   $0x8010797b
...
80104c91:	68 6f 79 10 80       	push   $0x8010796f
...
80104caf:	68 7e 79 10 80       	push   $0x8010797e
80104cb4:	e8 c7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104cb9:	83 ec 0c             	sub    $0xc,%esp
80104cbc:	68 60 79 10 80       	push   $0x80107960
...
80105225:	68 a0 79 10 80       	push   $0x801079a0
8010522a:	e8 51 b1 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
8010522f:	83 ec 0c             	sub    $0xc,%esp
80105232:	68 b2 79 10 80       	push   $0x801079b2
...
801058a3:	83 ec 08             	sub    $0x8,%esp
	return myproc()->P;
801058a6:	e8 e5 e0 ff ff       	call   80103990 <myproc>
801058ab:	8b 40 7c             	mov    0x7c(%eax),%eax
}
801058ae:	c9                   	leave  
801058af:	c3                   	ret    

801058b0 <sys_setprio>:
int
sys_setprio(void)
{
...
801058bc:	e8 bf f0 ff ff       	call   80104980 <argint>
801058c1:	83 c4 10             	add    $0x10,%esp
801058c4:	85 c0                	test   %eax,%eax
801058c6:	78 18                	js     801058e0 <sys_setprio+0x30>
	{
		return -1;
	}
	if(p<0 ||  p>7)
801058c8:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp)
801058cc:	77 12                	ja     801058e0 <sys_setprio+0x30>
		return -1;
	myproc()->P=p;
801058ce:	e8 bd e0 ff ff       	call   80103990 <myproc>
801058d3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801058d6:	89 50 7c             	mov    %edx,0x7c(%eax)
	return 0;
...
80105927:	c7 04 c5 c2 3e 11 80 	movl   $0x8e000008,-0x7feec13e(,%eax,8)
8010592e:	08 00 00 8e 
80105932:	66 89 14 c5 c0 3e 11 	mov    %dx,-0x7feec140(,%eax,8)
80105939:	80 
8010593a:	c1 ea 10             	shr    $0x10,%edx
8010593d:	66 89 14 c5 c6 3e 11 	mov    %dx,-0x7feec13a(,%eax,8)
80105944:	80 
  for(i = 0; i < 256; i++)
...
80105957:	c7 05 c2 40 11 80 08 	movl   $0xef000008,0x801140c2
8010595e:	00 00 ef 
  initlock(&tickslock, "time");
80105961:	68 c1 79 10 80       	push   $0x801079c1
80105966:	68 80 3e 11 80       	push   $0x80113e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010596b:	66 a3 c0 40 11 80    	mov    %ax,0x801140c0
80105971:	c1 e8 10             	shr    $0x10,%eax
80105974:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
...
8010599b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010599f:	b8 c0 3e 11 80       	mov    $0x80113ec0,%eax
...
801059e4:	ff 24 85 68 7a 10 80 	jmp    *-0x7fef8598(,%eax,4)
...
80105a03:	e8 88 df ff ff       	call   80103990 <myproc>
...
80105a20:	e8 6b df ff ff       	call   80103990 <myproc>
80105a25:	85 c0                	test   %eax,%eax
80105a27:	74 0f                	je     80105a38 <trap+0x78>
80105a29:	e8 62 df ff ff       	call   80103990 <myproc>
...
80105a32:	0f 84 b8 00 00 00    	je     80105af0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a38:	e8 53 df ff ff       	call   80103990 <myproc>
...
80105a90:	e8 db de ff ff       	call   80103970 <cpuid>
...
80105aa1:	e8 ea de ff ff       	call   80103990 <myproc>
80105aa6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105aa9:	e8 e2 de ff ff       	call   80103990 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ac5:	68 24 7a 10 80       	push   $0x80107a24
80105aca:	e8 d1 ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105acf:	83 c4 20             	add    $0x20,%esp
80105ad2:	e8 b9 de ff ff       	call   80103990 <myproc>
80105ad7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ade:	e8 ad de ff ff       	call   80103990 <myproc>
...
80105af4:	0f 85 3e ff ff ff    	jne    80105a38 <trap+0x78>
    yield();
80105afa:	e8 11 e5 ff ff       	call   80104010 <yield>
...
80105b0f:	e8 5c de ff ff       	call   80103970 <cpuid>
80105b14:	57                   	push   %edi
80105b15:	56                   	push   %esi
80105b16:	50                   	push   %eax
80105b17:	68 cc 79 10 80       	push   $0x801079cc
...
80105b3f:	90                   	nop
    if(myproc()->killed)
80105b40:	e8 4b de ff ff       	call   80103990 <myproc>
...
80105b55:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b58:	e8 63 ef ff ff       	call   80104ac0 <syscall>
    if(myproc()->killed)
80105b5d:	e8 2e de ff ff       	call   80103990 <myproc>
...
80105b73:	5d                   	pop    %ebp
      exit();
80105b74:	e9 37 e2 ff ff       	jmp    80103db0 <exit>
...
80105ba5:	e8 66 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105baa:	e8 e1 dd ff ff       	call   80103990 <myproc>
...
80105bbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105bc0:	e8 ab dd ff ff       	call   80103970 <cpuid>
80105bc5:	85 c0                	test   %eax,%eax
80105bc7:	0f 85 28 fe ff ff    	jne    801059f5 <trap+0x35>
      acquire(&tickslock);
80105bcd:	83 ec 0c             	sub    $0xc,%esp
80105bd0:	68 80 3e 11 80       	push   $0x80113e80
80105bd5:	e8 26 ea ff ff       	call   80104600 <acquire>
      wakeup(&ticks);
80105bda:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
      ticks++;
80105be1:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
80105be8:	e8 73 e5 ff ff       	call   80104160 <wakeup>
      release(&tickslock);
80105bed:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
...
80105c01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105c08:	e8 a3 e1 ff ff       	call   80103db0 <exit>
...
{
  if(!uart)
80105c50:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80105cd7:	74 78                	je     80105d51 <uartinit+0xd1>
  uart = 1;
80105cd9:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
80105ce0:	00 00 00 
...
80105cec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105cef:	bf e8 7a 10 80       	mov    $0x80107ae8,%edi
...
80106995:	e8 26 dd ff ff       	call   801046c0 <memset>
...
80106a80:	a1 c4 46 11 80       	mov    0x801146c4,%eax
...
80106ab4:	0f 84 c2 00 00 00    	je     80106b7c <switchuvm+0xec>
  pushcli();
80106aba:	e8 f1 d9 ff ff       	call   801044b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106abf:	e8 4c ce ff ff       	call   80103910 <mycpu>
80106ac4:	89 c3                	mov    %eax,%ebx
80106ac6:	e8 45 ce ff ff       	call   80103910 <mycpu>
...
80106ad8:	e8 33 ce ff ff       	call   80103910 <mycpu>
...
80106bcf:	e8 ec da ff ff       	call   801046c0 <memset>
...
80106c02:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c03:	e9 58 db ff ff       	jmp    80104760 <memmove>
    panic("inituvm: more than a page");
80106c08:	83 ec 0c             	sub    $0xc,%esp
80106c0b:	68 35 7b 10 80       	push   $0x80107b35
...
80106c70:	68 4f 7b 10 80       	push   $0x80107b4f
...
80106cf8:	68 f0 7b 10 80       	push   $0x80107bf0
...
80106d99:	68 6d 7b 10 80       	push   $0x80107b6d
...
80106dfb:	68 85 7b 10 80       	push   $0x80107b85
...
80106edc:	68 a1 7b 10 80       	push   $0x80107ba1
...
80106f10:	e8 ab d7 ff ff       	call   801046c0 <memset>
...
80106f7b:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fac:	68 b2 7b 10 80       	push   $0x80107bb2
...
80107022:	68 bc 7b 10 80       	push   $0x80107bbc
...
801070f7:	68 d6 7b 10 80       	push   $0x80107bd6
...
801071b0:	e8 ab d5 ff ff       	call   80104760 <memmove>
    len -= n;
    buf += n;
